...
def restore_tf_graph(sess, fpath):
    ...
    #model_info = dill.load(osp.join(fpath, 'model_info.pkl'))
    with open(osp.join(fpath, 'model_info.pkl'), 'rb') as f:
...
class Logger:
    ...
    def save_state(self, state_dict, itr=None):
        ...
        if proc_id()==0:
            ...
            try:
                ...
                ## dill.dump(state_dict, osp.join(self.output_dir, fname))
                ...
                try:
                    if 'env' in state_dict and \
                        ...
                        dill.dump({'spec': state_dict['env'].env.spec}, osp.join(self.output_dir, fname))
                finally:
    ...
    def _tf_simple_save(self, itr=None):
        ...
        if proc_id()==0:
            ...
            ## dill.dump(self.tf_saver_info, osp.join(fpath, 'model_info.pkl'))
            with open(osp.join(fpath, 'model_info.pkl'), 'wb') as f:
                dill.dump(self.tf_saver_info, f)
